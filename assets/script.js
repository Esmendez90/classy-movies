...
function startMovieSearch() {
  ...
  function display() {
    if (genre === 6) {
      ...
      var html =
        '<input id="id-movieinput" type="text" placeholder="Search movie"/> <input id="id-searchBtn" type="button" value="search"/>';
      document.getElementById("id-searchdiv").innerHTML = html;
      Buttonfunction = document
        .getElementById("id-searchBtn")
        .addEventListener("click", getmovie);
      console.log(genre);
